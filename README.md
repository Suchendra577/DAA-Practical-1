...
Run the standalone Python script for Practical 3 directly from your terminal:
```bash
python daa_practical_3_heap_sort.py
```
**Sample Terminal Run:**
```text
==================================================
...
==================================================
Enter numbers separated by spaces: 45 12 89 33 7 61

Original array: [45, 12, 89, 33, 7, 61]
Sorted array:   [7, 12, 33, 45, 61, 89]
...
1. Launch Jupyter Notebook server:
   ...
   jupyter notebook
   ```
2. Open any notebook (`DAA_Practical_1.ipynb`, `DAA_Practical_2.ipynb`, or `DAA_Practical_3.ipynb`).
